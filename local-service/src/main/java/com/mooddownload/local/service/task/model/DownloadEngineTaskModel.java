 ...
 * 下载子任务领域模型。
 */
public class DownloadEngineTaskModel {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof DownloadEngineTaskModel)) {
            return false;
        }
        DownloadEngineTaskModel that = (DownloadEngineTaskModel) object;
        return Objects.equals(engineGid, that.engineGid)
            && Objects.equals(parentEngineGid, that.parentEngineGid)
            && Objects.equals(engineStatus, that.engineStatus)
            && Objects.equals(torrentFiles, that.torrentFiles)
            && Objects.equals(metadataOnly, that.metadataOnly)
            && Objects.equals(totalSizeBytes, that.totalSizeBytes)
            && Objects.equals(completedSizeBytes, that.completedSizeBytes)
            && Objects.equals(downloadSpeedBps, that.downloadSpeedBps)
            && Objects.equals(uploadSpeedBps, that.uploadSpeedBps)
